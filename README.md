...
- **Wideo AI:** Opisz scenę tekstem — AnimateDiff, WAN 2.1 lub CogVideoX wygeneruje klip wideo na lokalnym GPU.
- **Praca w 100% offline:** Wszystkie modele działają lokalnie — żadnych subskrypcji, żadnych danych w chmurze.
...
| **Generator wideo** | Tekst → krótki klip wideo. Silniki: AnimateDiff (6 GB), WAN 2.1 (8 GB), CogVideoX-5B (16 GB / offload 12 GB), Runway API. |
...
| Generator wideo AI | AnimateDiff (8 GB), WAN 2.1 (12 GB), CogVideoX-5B (24 GB / offload), Runway (API) |
...
Testy przeprowadzone na NVIDIA RTX 3060 (12 GB VRAM), Python 3.12, CUDA 12.8. Celem było klonowanie głosu do narracji prezentacji po polsku i angielsku, bez halucynacji i artefaktów.
